...
public class Task1Test {
  ...
  public void task1() {
    ...
    driver.findElement(By.id("APjFqb")).sendKeys("salaar 2");
    ...
    {
      WebElement element = driver.findElement(By.cssSelector(".sgySOc"));
    ...
    {
      WebElement element = driver.findElement(By.cssSelector(".XJZlpb"));
      Actions builder = new Actions(driver);
      builder.moveToElement(element).perform();
    }
    {
